    ...
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          {/* Brand Section */}
          <Link href="/" className="self-stretch flex justify-start items-center gap-3 hover:opacity-80 transition-opacity">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">InstaAlert</div>
          </Link>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-end items-start gap-2">
              <Link href="#features" className="text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Features
              </Link>
              <Link href="#pricing" className="text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Pricing
              </Link>
              <Link href="#" className="text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Integrations
              </Link>
              <Link href="#" className="text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Real-time Previews
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <Link href="#" className="self-stretch text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Terms of use
              </Link>
              <Link href="#" className="self-stretch text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                API Reference
              </Link>
              <Link href="#docs" className="self-stretch text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Documentation
              </Link>
              <Link href="#" className="self-stretch text-[#49423D] text-sm font-normal leading-5 font-sans hover:text-[#37322F] transition-colors">
                Community
