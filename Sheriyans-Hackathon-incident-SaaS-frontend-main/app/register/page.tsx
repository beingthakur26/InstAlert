      ...
      <div className="w-full max-w-[440px] z-10 animate-in fade-in zoom-in duration-500">
        ...
        <Card className="border-[rgba(55,50,47,0.12)] shadow-xl shadow-[rgba(55,50,47,0.04)] bg-white/80 backdrop-blur-sm">
           <CardHeader className="space-y-1 pb-3 pt-4">
            <CardTitle className="text-2xl font-serif text-[#37322F]">Create an account</CardTitle>
            <CardDescription className="text-[#605A57] text-base">
              Join InstaAlert and streamline your contract billing
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleRegister}>
            <CardContent className="space-y-5 pt-2 pb-6">
              <div className="space-y-2.5">
                <Label htmlFor="username" className="text-[#37322F] font-medium">Username</Label>
                <Input 
                  id="username"
                  name="username"
                  type="text" 
